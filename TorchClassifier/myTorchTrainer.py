...
os.environ['TORCH_HOME'] = 'Desktop/CMPE\ 258/hw2/'
...
parser.add_argument('--img_height', type=int, default=32,
                    help='resize to img height, 32')
parser.add_argument('--img_width', type=int, default=32,
                    help='resize to img width, 32')
...
parser.add_argument('--wd', '--weight-decay', default=1e-4, type=float,
                    ...
                    dest='weight_decay')
parser.add_argument('--optimizer', default='SGD', choices=['SGD', 'Adam', 'AdamW', 'adamresnetcustomrate'],
